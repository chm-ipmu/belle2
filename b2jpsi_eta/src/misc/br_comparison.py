...
def make_pie(particle, decay_products, decay_fractions, path):
    ...
    plt.pie(
        sizes, labels=labels, autopct=fmt, shadow=True, colors=colors_, explode=explode
    )
...
if __name__ == "__main__":
    ...
    eta_fractions = [br.eta2gammagamma, br.eta23pi0, br.eta2pipipi0, br.eta2pipigamma]
    ...
    make_pie(
        r"\eta",
        decay_products=eta_modes,
        decay_fractions=eta_fractions,
        path=os.path.join(home, "eta.pdf"),
    )
    make_pie(
        r"J/\psi",
        decay_products=jpsi_modes,
        decay_fractions=jpsi_fractions,
        path=os.path.join(home, "jpsi.pdf"),
    )
